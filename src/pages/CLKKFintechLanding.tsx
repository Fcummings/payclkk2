    ...
    <div className="min-h-screen w-full overflow-x-hidden bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <header className="w-full max-w-7xl mx-auto px-4 py-20 text-center">
        <h1 className="mb-4 text-6xl font-bold tracking-tight">
          <span className="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">CLKK</span>
        </h1>
        <p className="mb-8 text-2xl font-light text-gray-300">Revolutionizing Nightlife Payments</p>
              ...
              <div className="bg-gray-700 p-8 rounded-lg shadow-xl">
                <div className="w-64 h-96 mx-auto bg-gray-800 rounded-3xl border-4 border-gray-600 p-4 flex flex-col justify-between">
                  ...
                  <div className="flex-grow flex items-center justify-center">
                    <div className="text-6xl font-bold text-blue-500">CLKK</div>
                  </div>
      ...
      <section className="w-full py-20 bg-gray-800">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              { name: "Alex", role: "Nightclub Owner", text: "CLKK has transformed our payment process. It's fast, secure, and our customers love it!" },
              { name: "Sarah", role: "Regular Clubgoer", text: "Splitting bills and paying for drinks has never been easier. CLKK is a game-changer!" },
              { name: "Mike", role: "Bar Manager", text: "The real-time insights we get from CLKK have helped us optimize our operations significantly." }
      ...
      <section className="w-full py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="mb-8 text-4xl font-bold">Ready to Transform Your Nightlife Experience?</h2>
          <p className="mb-8 text-xl text-gray-200">Join the CLKK revolution and say goodbye to payment hassles</p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-wrap justify-between">
            <div className="w-full md:w-1/3 mb-8 md:mb-0">
              <h3 className="text-2xl font-bold mb-4">CLKK</h3>
              <p className="text-gray-400">Revolutionizing nightlife payments with cutting-edge fintech solutions.</p>
            </div>
            <div className="w-full md:w-1/3 mb-8 md:mb-0">
